...
|**`build_regression_models.ipynb`** | Implements simple linear, KNN and logistic regression models |
...
- Both very high budgets and very low budgets can have a positive impact on predictions. This might be evidence of confounding between the budget and box office features in our dataset.

- Longer films consistently contribute to higher predicted box office.
